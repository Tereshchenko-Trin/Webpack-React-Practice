...
export function RecipeInfo({ name, image, ingredients, instructions, prepTimeMinutes, cookTimeMinutes, servings, caloriesPerServing }: IRecipeData) {
